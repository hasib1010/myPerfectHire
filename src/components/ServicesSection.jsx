  ...
  return (
    <section id="services" className="py-12 sm:py-16 lg:py-20 bg-white relative overflow-hidden" ref={sectionRef}>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <span className="inline-block px-3 py-1 rounded-full bg-[#4e124d]/10 text-[#4e124d] text-sm font-medium mb-4">Our Specialties</span>
        ...
        >
          {services.map((service, index) => (
            ...
            >
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-center mb-2 group-hover:text-[#4e124d]" style={{ color: service.color }}>
                {service.title}
              </h3>
        ...
        <div className="mt-12 sm:mt-16 rounded-2xl bg-gradient-to-r from-[#4e124d] to-[#e61c5c] p-1">
          <div className="bg-white rounded-xl py-8 px-4 sm:px-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
              {[
                { count: counts[0], label: "Elite Talent Access", color: "#e61c5c", unit: "%", delay: 0.1 },
                { count: counts[1], label: "Time to Hire Reduction", color: "#38c7ef", unit: "%", delay: 0.15 },
                { count: counts[2], label: "Success Rate", color: "#2bb87c", unit: "%", delay: 0.2 },
                { count: counts[3], label: "Day Guarantee", color: "#ecb324", unit: " Days", delay: 0.25 }
              ].map((stat, index) => (
                <motion.div
                  key={index}
                  ...
                  transition={{ duration: 0.3, delay: stat.delay }} // Reduced from 0.4
                >
                  <motion.div
                    className="text-3xl sm:text-4xl font-bold"
                    style={{ color: stat.color }}
                    animate={isInView ? { scale: [1, 1.1, 1] } : {}}
                    transition={{ duration: 0.3, delay: stat.delay + 0.1 }} // Faster pulse
                  >
        ...
        >
          ...
          <motion.a
            href="#contact"
            className="inline-block bg-[#4e124d] hover:bg-[#3d0e3d] text-white px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-medium shadow-md group relative overflow-hidden"
