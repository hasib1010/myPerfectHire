              ...
              <div className="bg-[#4e124d] p-4 rounded-lg">
                ...
                <div className="mt-8 flex flex-col items-center"> 
                  <div className="flex space-x-4">
                    ...
                    <a href="#" className="w-10 h-10 rounded-full bg-[#ecb324] flex items-center justify-center text-white transition-transform hover:scale-110">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                <p className="text-white text-base font-bold mt-4 bg-[#4e124d] p-3 rounded-lg  ">
